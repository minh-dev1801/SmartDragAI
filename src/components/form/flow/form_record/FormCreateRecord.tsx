...
interface FormCreateRecordProps {
  control: Control<FieldTypeFormRecord | CommonFormType>;
}

const FormCreateRecord = ({ control }: FormCreateRecordProps) => {
  return (
    <>
      ...
      <Form.Item>
        ...
        <p className="bg-[#EFF0FA] px-3 py-2 w-full rounded-sm">
          Chọn cách thiết lập giá trị cho bản ghi, đối tượng tạo bản ghi mới và
          biến sử dụng để lưu bản ghi được tạo mới.
        </p>
      </Form.Item>
